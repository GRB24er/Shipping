...
export const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      {/* Top bar - visible on large screens when not scrolled */}
      <div
        className={cn(
          "hidden lg:block transition-all duration-300 overflow-hidden bg-slate-950/95 backdrop-blur-xl border-b border-slate-800/50",
        ...
        <div className="container mx-auto px-4">
          <div className="flex h-16 items-center justify-between">
              ...
              {isAuthenticated ? (
                <>
                  ...
                  <InstantNavLink
                    ...
                    className="px-4 py-2 rounded-lg bg-gradient-to-r from-blue-600 to-blue-700 text-white text-sm font-medium hover:from-blue-500 hover:to-blue-600 transition-all shadow-lg shadow-blue-600/25"
                  >
                    Create Shipment
                  </InstantNavLink>
            ...
            <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
              ...
              <SheetContent
                side="right"
                className="w-full max-w-sm bg-slate-950 border-slate-800 p-0"
              >
                      ...
                      <>
                        ...
                        <div className="space-y-2 px-4 mb-4">
                          ...
                          <SheetClose asChild>
                            <InstantNavLink
                              href="/shipments/create"
                              className="flex items-center justify-center w-full px-4 py-3 rounded-lg bg-gradient-to-r from-blue-600 to-blue-700 text-white text-sm font-medium"
                            >
                              Create Shipment
                            </InstantNavLink>
                          </SheetClose>
                        ...
                        {session?.user?.role === "ADMIN" && (
                          <SheetClose asChild>
                            <InstantNavLink
                              href="/dashboard"
                              className="flex items-center gap-3 px-4 py-3 rounded-lg text-slate-300 hover:bg-slate-800/50"
                            >
                              <LayoutDashboard className="w-4 h-4" />
                              Dashboard
                            </InstantNavLink>
