  ...
  return (
    <section className="relative py-24 bg-gradient-to-b from-slate-900 to-slate-950 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 right-0 w-[700px] h-[700px] bg-blue-600/5 rounded-full blur-[150px]" />
          ...
          >
            <div>
              ...
              >
                ...
                <span className="text-sm font-medium text-blue-300">Our Excellence Record</span>
              </motion.span>
              ...
              >
                At AsyncShip, we&apos;re committed to delivering top-tier logistics
                services with unmatched reliability and efficiency. Our comprehensive
                approach combines advanced technology, expert teams, and sustainable
                practices.
              </motion.p>
            </div>
            ...
            >
              {achievements.map((item, index) => (
                <motion.div
                  key={index}
                  variants={fadeInUp}
                  className="flex items-center gap-3 p-4 rounded-xl bg-slate-800/30 border border-slate-700/30 hover:border-slate-600/50 transition-all group"
                >
          ...
          >
            <div className="relative max-w-lg mx-auto">
              ...
              <motion.div
                ...
                className="relative aspect-square rounded-3xl overflow-hidden border border-slate-700/50 shadow-2xl"
              >
                <Image
              ...
              <motion.div
                ...
                className="absolute -bottom-4 -left-4 p-4 bg-slate-800/90 backdrop-blur-xl rounded-2xl border border-slate-700/50 shadow-xl"
              >
                <div className="flex items-center gap-3">
              ...
              <motion.div
                ...
                className="absolute -top-4 -right-4 p-4 bg-slate-800/90 backdrop-blur-xl rounded-2xl border border-slate-700/50 shadow-xl"
              >
                <div className="flex items-center gap-3">
              ...
              <motion.div
                ...
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] border border-dashed border-slate-700/30 rounded-full pointer-events-none"
              />
            </div>
          </motion.div>
        </div>
