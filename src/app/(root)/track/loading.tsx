...
export default function Loading() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 relative overflow-hidden">
      ...
      <div
        className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-cyan-500/15 rounded-full blur-[100px] animate-pulse"
        style={{ animationDelay: "1s" }}
      />
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-indigo-600/10 rounded-full blur-[150px] animate-pulse"
      ...
      <div className="relative z-10 text-center">
        ...
        <p className="text-xs tracking-[0.5em] text-blue-400/80 uppercase mb-12">
          Logistics
        </p>
        ...
        <div className="w-80 mx-auto mb-6">
          <div className="h-[2px] bg-slate-800 rounded-full overflow-hidden">
            <div
              className="h-full bg-gradient-to-r from-blue-600 via-cyan-500 to-blue-600 rounded-full transition-all duration-300 ease-out relative"
        ...
        {/* Status text */}
        <p className="text-sm text-slate-400 font-light tracking-wide min-h-[20px] transition-opacity duration-300">
          {statusText}
        </p>
